...
//classe de conexão banco de dados
class Conexao {
...
//classe model (operacoes feitas com o banco de dados)
class Bd {
	private $conexao;
	private $dashboard;
